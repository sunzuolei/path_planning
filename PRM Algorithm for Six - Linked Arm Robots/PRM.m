...
% free space. Dist which measures the distance between two coordinate vectors and
% LocalPlanner which decides whether two samples are connected.
%
% Inputs :
%
